...
- [ ] **PR 1.1:** Update `index.html` with a chronological timeline container for `plan[]`.
- [ ] **PR 1.2:** Implement the Validation Status badge (PASS/FAIL) and Errors list sidebar.
- [ ] **PR 1.3:** Map `plan[]` items to render `task`, `start_time`, `end_time`, and `why`.
...
- [ ] **PR 2.1:** Add a "Context Extracted" section to render `extracted_metadata.detected_constraints`.
